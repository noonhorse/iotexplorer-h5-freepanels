...
import { SwitchItem } from '@src/panels/MultiSwitch/default/SwitchItem';
import { ConfirmModal } from '@src/components/Modal';
import { modifyModalName } from '@src/panels/FiveRoadHub/default/models';
...
export function SwitchPanel({
  ...
  return (
    statusTip
      ...
      : <FreePanelLayout
        className={classNames('switch-panel-page', { 'power-off': powerOff })}
